int __cdecl CUser::BaseGetAuthTicket(int a1, CUtlBuffer *a2, int gameID)
{
    CUtlBuffer *v3;                         // esi@1
    CUtlBuffer *v4;                         // eax@1
    int         v5;                         // edi@2
    ...
    v3 = a2;
    v4 = CUser::LoadAppOwnershipTicketFromDisk(a1, gameID & 0xFFFFFF);
    if (v4)
    {
        v5 = *((_DWORD *)v4 + 5);
