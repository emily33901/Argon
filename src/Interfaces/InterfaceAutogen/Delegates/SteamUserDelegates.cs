...
namespace InterfaceUser
{
    ...
    class SteamUser_Delegates
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate int GetAuthSessionTicketDelegate(IntPtr _, IntPtr ticket, uint ticket_size, ref System.Int32 ticket_written);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate void CancelAuthTicketDelegate(IntPtr _, int ticket_handle);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
