...
namespace InterfaceClient
{
    ...
    class ClientEngine_Delegates
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate int CreatePipeToLocalUserDelegate(IntPtr _, int user, ref System.Int32 pipe);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate void ReleaseUserDelegate(IntPtr _, int user, int pipe);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool IsValidHSteamUserPipeDelegate(IntPtr _, int pipe, int user);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
