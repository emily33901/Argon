...
namespace InterfaceUtils
{
    ...
    /// </summary>
    [ArgonCore.Interface.Delegate(Name = "SteamUtils009")]
    class SteamUtils009_Delegates
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool GetImageSize(IntPtr _, int image, ref System.UInt32 width, ref System.UInt32 height);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool GetImageRGBA(IntPtr _, int image, IntPtr dest, int total_dest);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool GetCSERIPPort(IntPtr _, ref System.UInt32 ip, ref System.UInt16 port);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool IsAPICallCompleted(IntPtr _, int handle, ref System.Boolean failed);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate int GetAPICallFailureReason(IntPtr _, int handle);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool GetAPICallResult(IntPtr _, int handle, IntPtr callback, int callback_size, int callback_expected, ref System.Boolean failed);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
