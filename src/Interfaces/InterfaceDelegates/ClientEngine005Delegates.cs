...
namespace InterfaceClient
{
    ...
    /// </summary>
    [ArgonCore.Interface.Delegate(Name = "CLIENTENGINE_INTERFACE_VERSION005")]
    class CLIENTENGINE_INTERFACE_VERSION005_Delegates
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate int CreateGlobalUser(IntPtr _, ref System.Int32 pipe);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate int CreatePipeToLocalUser(IntPtr _, int user, ref System.Int32 pipe);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool GetAPICallResult(IntPtr _, int pipe, uint handle, ref System.IntPtr callback_buffer, int callback_size, int expected_callback, ref System.Boolean failed);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
