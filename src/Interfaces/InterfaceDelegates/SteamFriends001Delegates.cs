...
namespace InterfaceFriends
{
    ...
    /// </summary>
    [ArgonCore.Interface.Delegate(Name = "SteamFriends001")]
    class SteamFriends001_Delegates
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool Deprecated_GetFriendGamePlayed(IntPtr _, ulong steam_id, ref System.UInt32 app_id, ref System.UInt32 game_ip, ref System.UInt32 game_port);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate int GetChatMessage(IntPtr _, ulong steam_id, int msg_index, IntPtr msg_out, int max_msg, ref System.UInt32 msg_type);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool GetFriendGamePlayed(IntPtr _, ulong steam_id, ref System.UInt64 game_id, ref System.UInt32 server_ip, ref System.UInt16 server_port);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool GetFriendGamePlayed2(IntPtr _, ulong steam_id, ref System.UInt64 game_id, ref System.UInt32 server_ip, ref System.UInt16 server_port);
    }
}
