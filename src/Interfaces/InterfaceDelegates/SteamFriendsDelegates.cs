...
namespace InterfaceFriends
{
    ...
    class SteamFriends_Delegates
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool SendMsgToFriend2Delegate(IntPtr _, ulong steam_id, uint type, string message, int length);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        public delegate bool GetFriendGamePlayed3Delegate(IntPtr _, ulong steam_id, IntPtr friend_game_info_out);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
